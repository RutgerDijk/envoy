...
Multi-layer code review that cleans, reviews, verifies visually, and documents. Run this after implementation, before finalize. Complexity tiers control which layers run and how deep they go.
...
| `--quick` | Layers 0 and 0.5 only (for fast feedback) |
...
- For quick feedback during implementation: `/envoy:review --quick`
